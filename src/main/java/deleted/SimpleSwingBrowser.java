...
public class SimpleSwingBrowser extends JFrame {
    ...
    private final JPanel buttonpanel = new JPanel(new BorderLayout(5, 0));
...
//        buttonpanel.add(btnGo, BorderLayout.EAST);
//        buttonpanel.add(button, BorderLayout.WEST);
        ...
        lblStatus.setPreferredSize(new Dimension(150, 18));
        statusBar.add(lblStatus, BorderLayout.CENTER);
        JLabel kreditLabel=new JLabel("Kredit");
        kreditLabel.setPreferredSize(new Dimension(150, 18));
