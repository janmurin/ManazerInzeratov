...
//    }
    ...
    /**
     * This is the main function to generate the graphics of the Node using the FXPanel inside the
     * JFrame.
     *
     * @param node
     * @param f
    ...
    /**
     * This is the main function to generate the graphics of the scene using the FXPanel inside the
     * JFrame.
     *
     * @param sc
     * @param f
    ...
    /**
     * This function restores the main Scene to the original Stage from where the event has been
     * triggered
     */
